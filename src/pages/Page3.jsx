...
const Page3 = () => {
  return (
    <div id='skill' className="items-center flex flex-col w-full h-fit  px-15 py-15 gap-4  bg-[#020817]  max-[600px]:px-7 ">
      <h1 className=" whitespace-nowrap text-[35px] min-[650px]:text-[55px] text-[#997FE1] font-medium ">
        Skills & Technology
      </h1>
      <h2 className="whitespace-nowrap text-[12px] min-[650px]:text-xl text-[rgb(148,163,184)] ">
        Technologies I work with to build amazing applications
      </h2>
      <div className="w-full h-fit px-20 bg-[#202C40]  rounded-xl py-5  mt-4 flex flex-col gap-6 items-center">
        <div className=" ">
          <h1 className=" whitespace-nowrap text-[20px] min-[650px]:text-[25px] text-center  text-[#6565E7]  font-medium">
  ...
  min-[550px]:flex-row
  min-[550px]:justify-between flex-col gap-2 shrink-0 flex-wrap  w-full"
        >
